...
var badDishes = [];
var dishesExtra = [];
var goodDishString = ": This contains the vegetable that we need.";
var badDishString = ": We don't care for this dish";
dishes.forEach(function(dish) {
  if (dish.includes("Brussels")) {
    goodDishes.push(dish);
    dishesExtra.push(dish.concat(goodDishString));
  } else {
    badDishes.push(dish);
    dishesExtra.push(dish.concat(badDishString));
  }});

dishesExtra.forEach(function(dish) {
  console.log(dish);
});
